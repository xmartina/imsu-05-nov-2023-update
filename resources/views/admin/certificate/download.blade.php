...
<div class="template-container" id="downloadable" style="border-image: url('{{ asset('uploads/'.$path.'/'.$certificate->template->background) }}') 30 round; width: {{ $certificate->template->width }}; height: {{ $certificate->template->height }};">
